BEGIN
  BEGIN
    EXECUTE IMMEDIATE 'DROP TABLE nf_tricks_1nf CASCADE CONSTRAINTS';
  EXCEPTION
    WHEN OTHERS THEN
      NULL;
  END;
  ...
  BEGIN
    EXECUTE IMMEDIATE 'DROP TABLE nf_puppies_1nf CASCADE CONSTRAINTS';
  EXCEPTION
    WHEN OTHERS THEN
      NULL;
  END;
...
CREATE TABLE nf_puppies_1nf (
  puppy_number NUMBER PRIMARY KEY,
...
CREATE TABLE nf_tricks_1nf (
  ...
  CONSTRAINT nf_tricks_1nf_fk FOREIGN KEY
    (puppy_number) REFERENCES nf_puppies_1nf(puppy_number),
  CONSTRAINT nf_tricks_1nf_skill_level_ck
    CHECK (skill_level >= 1 AND skill_level <= 5)
);

INSERT INTO nf_puppies_1nf
...
INSERT INTO nf_tricks_1nf
  (puppy_number, trick_id, trick_name, skill_level)
  VALUES (52, 27, 'Roll Over', 5);
INSERT INTO nf_tricks_1nf
  (puppy_number, trick_id, trick_name, skill_level)
  VALUES (53, 12, 'Sit', 3);
INSERT INTO nf_tricks_1nf
  (puppy_number, trick_id, trick_name, skill_level)
  VALUES (53, 30, 'Shake Paws', 4);
INSERT INTO nf_tricks_1nf
  (puppy_number, trick_id, trick_name, skill_level)
  VALUES (54, 27, 'Roll Over', 4);
INSERT INTO nf_tricks_1nf
  (puppy_number, trick_id, trick_name, skill_level)
  VALUES (55, 27, 'Roll Over', 2);
INSERT INTO nf_tricks_1nf
  (puppy_number, trick_id, trick_name, skill_level)
  VALUES (55, 30, 'Shake Paws', 5);
INSERT INTO nf_tricks_1nf
  (puppy_number, trick_id, trick_name, skill_level)
  VALUES (57, 16, 'Speak', 5);
